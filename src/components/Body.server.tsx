...
export default function Body({ userData }: { userData: UserData }) {
  ...
  return (
    <div className="mt-4 flex flex-col items-start rounded-2xl bg-white px-6 pt-8 pb-[42px] shadow-custom dark:bg-neutral-dark-blue-700 tablet:p-10 desktop:p-[48px]">
      <div className="flex items-center gap-5 tablet:gap-10 desktop:max-w-[480px]">
        <img
      ...
      <h4 className="mt-[33px] w-[480px] leading-6 text-secondary-blue dark:text-white tablet:text-[0.9375em] tablet:leading-[1.5625rem] desktop:max-w-[480px] desktop:self-end">
